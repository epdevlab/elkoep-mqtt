...
class BusErrors(Enum) :
    ...
    BUS_4B_NOT_CALIBRATED = 0x7FFFFA,
    BUS_4B_NO_VALUE = 0x7FFFFB,
    BUS_4B_NOT_CONFIGURED = 0x7FFFFC,
    BUS_4B_OUT_OF_RANGE = 0x7FFFFD,
    BUS_4B_MEASURE = 0x7FFFFE,
    BUS_4B_NO_SENSOR = 0x7FFFFF,
    BUS_4B_NOT_COMMUNICATING = 0x7FFFF9,
