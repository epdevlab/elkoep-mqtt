...
def test_discovery_successful(mqtt_mock, discovery):
    ...
    mqtt_mock.discovery_all.return_value = {
        "10e97f8b7d30/01/01E8": "data",
        "10e97f8b7d30/03/03E8": "data"
    }
    expected_devices = [Device(mqtt_mock, "inels/status/10e97f8b7d30/01/01E8"),
    ...
    assert all(d.state_topic == e.state_topic for d, e in zip(discovered_devices, expected_devices))
